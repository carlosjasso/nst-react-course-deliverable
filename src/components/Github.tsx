...
export default function Github({ octocatColor }: GithubProps) {
    ...
    return(
        <svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" viewBox="0 0 250 250" fill={octocatColor} style={cornerStyle} >
